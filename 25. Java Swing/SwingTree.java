...
class MyFrames2 extends JFrame implements TreeSelectionListener
{
    JTree tree;
    JLabel label;
    ...
    MyFrames2()
    {
        ...
        DefaultMutableTreeNode root=new DefaultMutableTreeNode("C:\\Downloads");
